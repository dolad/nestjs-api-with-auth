    ...
    imports: [
          SequelizeModule.forRootAsync({
            ...
            useFactory: async (config: ConfigService) => ({
              ...
              models:[User, Kyc, BusinessEntity, BusinessInformation, BusinessType, BankProviderCountries, BankProvider, FinancialConnectDetails, SoftwareConnectDetails, UserSession, FundingRequirement,BusinessOwners],
              autoLoadModels: true,
               sync: {
                force: false,
                alter: false,
